...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" runat="server">
    ...
    <div class="card card-custom p-4 shadow-sm border-0">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <h2>Usuarios</h2>
                <p>Gestión de usuarios del sistema y roles.</p>
            </div>

            <a href="NuevoUsuario.aspx" class="btn btn-primary d-flex align-items-center gap-2">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3">
                 <label class="form-label fw-semibold text-muted small">Buscar Usuario</label>
                <div class="input-group">
                    <span class="input-group-text bg-white border-end-0"><i class="bi bi-search text-muted"></i></span>
                    <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control border-start-0" placeholder="Buscar por Nombre o Username..." AutoPostBack="true" OnTextChanged="txtBuscar_TextChanged" />
                </div>
            </div>

            <div class="col-md-3">
                <label class="form-label fw-semibold text-muted small">Filtrar por Rol</label>
